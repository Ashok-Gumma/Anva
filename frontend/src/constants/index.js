...
export const CEFR_LEVELS = [
  { level: "A1 Beginner", code: "A1", desc: "Just starting out", badge: "bg-emerald-500/10 text-emerald-600 border-emerald-500/20" },
  { level: "A2 Elementary", code: "A2", desc: "Basic phrases & vocabulary", badge: "bg-teal-500/10 text-teal-600 border-teal-500/20" },
  { level: "B1 Intermediate", code: "B1", desc: "Everyday conversation", badge: "bg-blue-500/10 text-blue-600 border-blue-500/20" },
  { level: "B2 Upper Intermediate", code: "B2", desc: "Fluent & confident", badge: "bg-indigo-500/10 text-indigo-600 border-indigo-500/20" },
  { level: "C1 Advanced", code: "C1", desc: "Complex & technical topics", badge: "bg-purple-500/10 text-purple-600 border-purple-500/20" },
  { level: "C2 Native/Master", code: "C2", desc: "Native / Master fluency", badge: "bg-amber-500/10 text-amber-600 border-amber-500/20" },
];
